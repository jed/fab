...
fab.handle = function( respond ) {
  ...
  while ( i-- ) {
    ...
    return context.handler.apply( this, arguments );
  }
  
  context.status[ 404 ].apply( this, arguments );
}

var responseKeys = { status: 1, headers: 1, body: 1, _encoding: 1 }
...
fab.each( [ 1, 6, 5, 15, 5 ], function( c, i ) {
  fab.each( Array( i + 1 ), function( i ) {
    ...
    fab.prototype[ code ] = function( fn ) {
      ...
      this.status[ code ] = function( respond ) {
        respond({ status: code });
        return fn.call( this, respond );
      };
